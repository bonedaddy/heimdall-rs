...
use super::{
    constants::DECOMPILED_SOURCE_HEADER, postprocess::postprocess, util::Function, DecompilerArgs,
};
...
pub fn build_output(
    ...
    decompiled_output.push(DECOMPILED_SOURCE_HEADER.replace("{}", env!("CARGO_PKG_VERSION")));
